...
-- Creating a copy of the cleaning table changing some types and excluding the drivers_license_state, the ems_run_no, ejection, drivers_license_class columns
